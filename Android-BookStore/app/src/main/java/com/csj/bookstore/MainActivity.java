...
//        final CircleProgressBar progressView = (CircleProgressBar) findViewById(R.id.progressBar);
//        progressView.onAnimationStart();
...
//        webSettings.setBuiltInZoomControls(true); //设置内置的缩放控件。若为false，则该WebView不可缩放
        ...
        webView.loadUrl(this.getString(R.string.web_client_home_page));
